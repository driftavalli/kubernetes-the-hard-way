...
data:
  ...
  etcd-config: |-
    ---
    endpoints:
      - https://10.240.70.10:2379
      - https://10.240.70.11:2379
      - https://10.240.70.12:2379
    #
  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        image: docker.io/cilium/cilium:v1.5.5
...
kubectl create secret generic -n kube-system cilium-etcd-secrets \
     ...
     --from-file=etcd-client.key=kubernetes-key.pem \
     --from-file=etcd-client.crt=kubernetes.pem
```

Create Cilium objects in Kubernetes Cluster
```
kubectl apply -f /home/dude/projects/kubernetes/CKA/configFiles/certs/cilium-crio.yaml
```
